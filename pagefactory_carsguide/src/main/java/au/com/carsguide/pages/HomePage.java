...
public class HomePage extends Utility {
    ...
    public void mouseHoverToBuySellLink() {
        Reporter.log("This will mouse on buy sell link" + _buySellLink.toString() + "<br>)");
...
//This method will click on Used search cars link
    public void clickOnUsedSearchCarsLink() {
        Reporter.log("This will click on used search cars link" + _usedSearchLink.toString() + "<br>)");
