...
public class NewAndUsedCarSearchPage extends Utility {
    ...
    public void verifyUserIsOnNewAndUsedCarSearch() {
        Reporter.addStepLog("Verify that user is on new and used car search page " + _verifySearchCarsText.toString() + "<br>");
    ...
    public void selectAnyMakeFieldAndSelectBrand(String brand) {
        Reporter.addStepLog("Select any make field and select BMW" + _anyMakeField.toString() + "<br>");
    ...
    public void selectAnyModelFieldAndSelectModel(String model) {
        Reporter.addStepLog("Select any model field and select series" + _anyModelFiled.toString() + "<br>");
    ...
    public void selectAnyLocationAndSelectLocation(String location) {
        Reporter.addStepLog("Select any location field and select location" + _anyLocationField.toString() + "<br>");
    ...
    public void selectPriceMaxFieldAndSelectPrice(String price) {
        Reporter.addStepLog("Select price max field and select price" + _priceMaxField.toString() + "<br>");
    ...
    public void clickOnFindMyNextCarButton(){
        Reporter.addStepLog("clicking on find my next car button"+_findMyNextCarButton.toString()+"<br>");
